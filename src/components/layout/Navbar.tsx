                    ...
                    <div className={cn(
                      ...
                      {user ? (
                        <>
                          ...
                          {user?.role === 'admin' && (
                            <button
                              className="w-full flex items-center gap-2 px-4 py-2 hover:bg-mangla-gold/10 transition-colors border-b border-gray-100 dark:border-gray-700"
                              onClick={() => { 
                        ...
                        <>
                          <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                            ...
                            <div className="text-xs text-gray-500">Please login to continue</div>
                          </div>
                          <button
                            className="w-full flex items-center gap-2 px-4 py-2 hover:bg-mangla-gold/10 transition-colors"
              ...
              <div className={`mt-auto border-t ${isDark ? 'border-slate-700 bg-slate-800' : 'border-gray-200 bg-gray-50'} px-6 py-4`}>
                ...
                <div className="mt-4 flex justify-between items-center">
                  <div className="flex space-x-4">
                    <a href="https://www.facebook.com/share/169gSkJBEa/" className={`${isDark ? 'text-gray-400 hover:text-white' : 'text-gray-500 hover:text-black'} transition-colors`}>
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                      </svg>
                    </a>
                    <a href="https://www.instagram.com/manglasports_?igsh=NHVrd3hiYzI4Y2M2" className={`${isDark ? 'text-gray-400 hover:text-white' : 'text-gray-500 hover:text-black'} transition-colors`}>
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
