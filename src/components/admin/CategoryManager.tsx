...
interface CategoryManagerProps {
  ...
  onEditModalOpen: (category: any) => void;
...
export default function CategoryManager({
  categories, loading, error, addModalOpen, editModalOpen, editingCategory,
  newCategoryName, onAddModalOpen, onAddModalClose, onEditModalOpen, onEditModalClose,
  onNewCategoryChange, onAddCategory, onEditCategory, onDeleteCategory
    ...
    <>
      ...
      <Dialog open={editModalOpen} onOpenChange={onEditModalClose}>
        <DialogContent className="max-w-md">
          ...
          <DialogFooter>
            <Button onClick={onEditCategory} disabled={loading || !editingCategory?.name?.trim()}>
